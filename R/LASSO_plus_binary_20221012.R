...
LASSO_plus_binary = function(dat, y01, VarNames, patientID = "res_id", filename = "default", 
  ...
  vars = intersect(VarNames, colnames(dat))
  dat = cbind(fdat, dat)
...
# res = binaryVarSelectionLASSO_plus(dat=tdat, y01 = "CODE_postBMTFFS", VarNames = vars,topN = 10,
